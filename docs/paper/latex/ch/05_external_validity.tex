...
forecast through the degree route (MPD) (\textbf{Figure 5};
...
\(0.11\) (CE-PG: \(0.782<0.883\)). \textbf{F3 is universal and confirms
its own logic}: the consistency upside (best prediction algorithm at
perfect advice, over the floor) is small everywhere (mean \(+0.049\);
range \(+0.022\)--\(+0.077\)), and it is \emph{smallest exactly where
the baseline is strongest} --- the two dense economic graphs, with
