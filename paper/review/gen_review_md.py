...
SOURCES = [
    ("摘要 + 引言", EN / "00_abstract_intro.md", "00_abstract_intro.review.md", ""),
    ("§2 Setup", EN / "01_setup.md", "01_setup.review.md", ""),
    ("§3 Unified benchmark", EN / "02_unified_benchmark.md", "02_unified_benchmark.review.md", ""),
    ("§4 Order error", EN / "03_order_error.md", "03_order_error.review.md", ""),
    ("§5 Test-and-fallback", EN / "04_test_and_fallback.md", "04_test_and_fallback.review.md", ""),
    ("§6 External validity", EN / "05_external_validity.md", "05_external_validity.review.md", ""),
    ("§7 Budget–stakes law", EN / "06_theory.md", "06_theory.review.md", ""),
    ("§8–10 Serving / related / conclusion", EN / "07_serving_related_conclusion.md", "07_serving_related_conclusion.review.md", ""),
]
...
def main():
    ...
    lines = ["# 审读总表", "",
             f"八个单元（摘要+引言、§2–§10）共 **{len(all_ann)} 条**批注，七个审稿视角。", "",
             "按视角与严重度：", "",
             "| 视角 | 🔴 必改 | 🟡 建议 | ⚪ 可选 | 合计 |", "|---|---|---|---|---|"]
    for r in roles:
