...
tests. The statistics throughout is deliberately classical; the
contribution is the structural identity under which a passive arrival
stream --- no actions, no rewards --- reveals a policy pair's payoff gap
at all. Because the stakes are capped by the baseline slack, on
