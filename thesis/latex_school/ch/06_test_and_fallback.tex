...
of perfect advice grows, but the upside a sublinear test can safely
capture stays near zero, because the empirical test's resolution sits
far above the break-even margin wherever the upside exists.}
\end{figure}
