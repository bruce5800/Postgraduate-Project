...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio,alt={The impossibility scissors: the potential upside grows as the baseline weakens (left), but the upside a sublinear test can safely capture stays near zero; the test's resolution sits far above the break-even margin (right).}]{../../results/impossibility_frontier.png}
\caption{The impossibility scissors: the \emph{potential} upside grows
as the baseline weakens (left), but the upside a sublinear test can
\emph{safely capture} stays near zero; the test's resolution sits far
above the break-even margin (right).}
\end{figure}
