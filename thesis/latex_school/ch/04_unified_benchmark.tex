...
the error models of §3.3 --- degree panels: \emph{perfect} (true
realized degrees), \emph{noisy} (random-flip at strength \(\tfrac12\)),
...
within-panel comparisons carry meaning. \textbf{Table 4.1} presents each
panel's ratios beside its bar chart; the findings follow in §4.2.
...
augmentations, TestAndMatch, the combiner --- avoids this by
construction.
...
inputs (Panel B: \(0.760\) / \(0.788\), below Greedy's \(0.890\)); the
...
why the wall is forced, not accidental.
