...
![不可能性的数值面（"剪刀"）。左：随基线变弱，*潜在*上升空间增长，但亚线性检验能*安全捕获*的上升空间保持近零。右：无论何处有上升空间，检验的经验 $\ell_1$ 分辨率都远高于盈亏平衡余量。](../../../results/impossibility_frontier.png){width=100%}
...
证明立于三根支柱；我们用文字陈述每根，并给出其一个关键公式，将形式化细节留到附录。
...
[CJKL22, VV11]。我们的构造有 $r=\Theta(n)$ 个类型，故检验需要 $\tilde\Theta(n/\log n)$ 个样本——多于
