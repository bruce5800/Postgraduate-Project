...
- **An impossibility theorem** (Chapter 9): no test-and-fallback algorithm whose test
  ...
  *(The theorem's full proof is complete in architecture — its core lemma rigorous and its
...
sentence: **on average-case online matching, predictions are robustness insurance rather
