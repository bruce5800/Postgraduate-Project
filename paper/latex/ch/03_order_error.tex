...
every point --- by roughly \(16\times\)

(adversarial) to \(75\times\) (distribution-drift). Figure 2(a) plots
loss against \(n-\mathrm{LIS}\) with the \(y=x\) bound; all points lie
close to the axis.
...
Kendall-\(\tau\) order error (Figure 2(b)), the four structured error
