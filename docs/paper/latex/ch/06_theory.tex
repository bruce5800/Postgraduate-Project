...
constant. Section 5.4 carries the rule from the hard family to the
benchmark itself, where the plug-in payoff must additionally survive a
concavity bias at the capacity kinks --- it does, with a bootstrap
calibration that still uses no problem constants.
