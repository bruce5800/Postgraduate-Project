...
test than the prediction's distance --- a prescription we validate on
the benchmark, where a constant-free payoff-testing rule avoids the
threshold pathologies of the deployed tests. Because the stakes are
