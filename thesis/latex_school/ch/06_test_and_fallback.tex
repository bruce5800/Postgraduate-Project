...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={The robustness envelope: blind FollowPrediction crashes below the advice-free floor as advice error grows; TestAndMatch stays on the upper envelope.}]{../../results/choo_bem_envelope.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={Testing cost at borderline advice: a larger, more accurate prefix test makes the worse decision under the worst-case-calibrated threshold.}]{../../results/choo_bem_prefix.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={Recalibration removes the threshold pathology: misjudgement holds at zero at every prefix size, versus climbing toward 1.0 under the worst-case threshold.}]{../../results/recalibration_prefix.png}
