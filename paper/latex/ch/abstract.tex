...
specialist mass \(\sigma^2\) (exactly twice its baseline slack) divided
by the squared stakes \(g\) (what good advice gains over the baseline),
independent of the instance length. The lower half binds \emph{every}
