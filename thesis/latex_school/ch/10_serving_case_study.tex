...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio,alt={Capacity as robustness: blindly following the forecast crashes goodput --- deeper at ample capacity (c=8) --- while the adaptive test stays flat.}]{../../results/serving_envelope.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={The cache-affinity reversal (Mooncake trace): stable placement beats reactive routing for KV-cache reuse.}]{../../results/prefix_cache_reversal.png}
