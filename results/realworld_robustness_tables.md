...
| Feldman  *(advice-free)* | 0.752 ±0.004 | 0.752 ±0.004 | 0.752 ±0.004 | 0.752 ±0.004 |
| JailletLu  *(advice-free)* | 0.787 ±0.004 | 0.787 ±0.004 | 0.787 ±0.004 | 0.787 ±0.004 |
...
| Feldman(MPD) | 0.952 ±0.004 | 0.942 ±0.004 | 0.919 ±0.004 | 0.935 ±0.004 |
| JailletLu(MPD) | 0.952 ±0.003 | 0.944 ±0.003 | 0.926 ±0.003 | 0.938 ±0.003 |

*F1 crash=True, aug-safe=True; F2 robust=True (aug spread 0.033 vs MPD 0.124, ratio 0.26); F3 upside=+0.054*
...
| Feldman  *(advice-free)* | 0.748 ±0.004 | 0.748 ±0.004 | 0.748 ±0.004 | 0.748 ±0.004 |
| JailletLu  *(advice-free)* | 0.781 ±0.005 | 0.781 ±0.005 | 0.781 ±0.005 | 0.781 ±0.005 |
...
| Feldman(MPD) | 0.944 ±0.004 | 0.934 ±0.003 | 0.911 ±0.003 | 0.925 ±0.003 |
| JailletLu(MPD) | 0.942 ±0.004 | 0.933 ±0.003 | 0.917 ±0.004 | 0.928 ±0.004 |

*F1 crash=True, aug-safe=True; F2 robust=True (aug spread 0.033 vs MPD 0.113, ratio 0.29); F3 upside=+0.050*
...
| Feldman  *(advice-free)* | 0.757 ±0.003 | 0.757 ±0.003 | 0.757 ±0.003 | 0.757 ±0.003 |
| JailletLu  *(advice-free)* | 0.787 ±0.003 | 0.787 ±0.003 | 0.787 ±0.003 | 0.787 ±0.003 |
...
| Feldman(MPD) | 0.951 ±0.002 | 0.941 ±0.002 | 0.916 ±0.002 | 0.933 ±0.002 |
| JailletLu(MPD) | 0.950 ±0.002 | 0.943 ±0.002 | 0.922 ±0.002 | 0.936 ±0.002 |

*F1 crash=True, aug-safe=True; F2 robust=True (aug spread 0.035 vs MPD 0.148, ratio 0.24); F3 upside=+0.057*
...
| JailletLu  *(advice-free)* | 0.819 ±0.004 | 0.819 ±0.004 | 0.819 ±0.004 | 0.819 ±0.004 |
...
| Feldman(MPD) | 0.960 ±0.002 | 0.951 ±0.002 | 0.922 ±0.003 | 0.944 ±0.003 |
| JailletLu(MPD) | 0.960 ±0.002 | 0.954 ±0.002 | 0.930 ±0.003 | 0.948 ±0.003 |

*F1 crash=True, aug-safe=True; F2 robust=True (aug spread 0.038 vs MPD 0.175, ratio 0.22); F3 upside=+0.078*
...
| Feldman  *(advice-free)* | 0.737 ±0.005 | 0.737 ±0.005 | 0.737 ±0.005 | 0.737 ±0.005 |
| JailletLu  *(advice-free)* | 0.765 ±0.005 | 0.765 ±0.005 | 0.765 ±0.005 | 0.765 ±0.005 |
...
| Feldman(MPD) | 0.994 ±0.003 | 0.978 ±0.003 | 0.939 ±0.003 | 0.968 ±0.003 |
| JailletLu(MPD) | 0.992 ±0.002 | 0.978 ±0.003 | 0.942 ±0.003 | 0.968 ±0.003 |

*F1 crash=True, aug-safe=False; F2 robust=False (aug spread 0.055 vs MPD 0.107, ratio 0.51); F3 upside=+0.035*
...
| Feldman(MPD) | 0.998 ±0.001 | 0.987 ±0.002 | 0.955 ±0.003 | 0.979 ±0.003 |
| JailletLu(MPD) | 0.998 ±0.001 | 0.987 ±0.002 | 0.954 ±0.003 | 0.979 ±0.003 |

*F1 crash=True, aug-safe=False; F2 robust=False (aug spread 0.044 vs MPD 0.086, ratio 0.51); F3 upside=+0.022*
