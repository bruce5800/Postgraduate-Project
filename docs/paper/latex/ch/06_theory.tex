...
test is analyzed here only on the cell family; its novelty relative to
payoff-estimating switching rules elsewhere in the learning-augmented
literature is under a dedicated literature pass. We credit Choo et
al.~for the constructive baseline-coupling their threshold already
exhibits; our contribution is the two-sided, rule-independent budget
law, the payoff/distance separation, and the quantified wall.
