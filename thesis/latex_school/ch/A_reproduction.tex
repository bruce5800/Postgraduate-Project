...
The quantities behind the outlook of §10.2 are numerically verified. The
single-cell constants of the rare-resource construction (per-cell OPT,
baseline, and the advantage/\(\ell_1\) formulas) and the exact affine
conversion law
...
formal development is companion work outside this thesis.
