...
\item
  ...
  This heavy-tailed profile gives a \emph{degree} predictor genuine
  signal to carry.
\item
...
different prediction objects with different knobs), so only within-panel
...
TestAndMatch toward the ideal top-right corner, are visible at a glance.
