...
Section 3: the engineered mechanism
...
accuracy only makes the algorithm follow that miscalibrated threshold
more faithfully.
...
budget--stakes scaling of Section 7, with this family's payoff estimator
carrying per-sample variance of order one, resolving stakes of \(0.02\)
takes \(k \approx 1/0.02^2 = 2500 > n\) --- the law binds our rule too,
and the right behavior at
...
Ranking to Mimic mid-run lands the
