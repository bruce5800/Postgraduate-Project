...
pairing that a unified table makes immediate.

\section{Chapter summary}

The value of a prediction here is downside protection, not performance.
The next question is what governs the loss that remains --- and Chapter
5 shows it is not the size of the prediction error but the order it
induces.
